	...
	render(){
		...
		if (course.type == 'online'){
			if (this.props.unit.index < 1){ // always show first video
				...
				videoThumb = <div style={{border:'1px solid #ddd', padding:12, background:'#f9f9f9', marginTop:12, marginBottom:12}}>To view this video, please <a onClick={this.subscribe} style={{color:'red'}} href="#">subscribe</a> or <a style={{color:'red'}} href="/checkout">upgrade</a> your account to Premium</div>
			}
