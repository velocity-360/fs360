...
var initialState = {
	...
	instructors: [
		...
		{name:'Anna Garcia', image:'anna.png', tags:['Node JS', 'React', 'Angular JS', 'JQuery'], bio:"A recent graduate of the Grace Hopper coding school for women, Anna is a life-long tech enthusiast, musician, and fitness fanatic. Founder of the original JuiceCrawl (http://www.juicecrawl.com), Anna explored technology and programming on her own before deciding to make it her career in 2015. With a  background in Node, Express, Angular, and SQL, Anna will be helping out as a teaching assistant for several courses."}
	],
	banners:[
		'hackathon.jpg',
		'hacking-2.jpg',
	...
	faq: {
		highschool:[
			...
			{question:'I don’t have a lot of experience coding - can I still take your summer class?', answer:'Of course!  Velocity High school summer program is designed with students that have limited experience in mind.  If you have some knowledge of coding, that is great! But if not that does not mean we cannot teach you.'},
