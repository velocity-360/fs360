...
var EditProject = (function (Component) {
	function EditProject(props, context) {
		_classCallCheck(this, EditProject);

		_get(Object.getPrototypeOf(EditProject.prototype), "constructor", this).call(this, props, context);
	}

	_inherits(EditProject, Component);

	_prototypeProperties(EditProject, null, {
		render: {
