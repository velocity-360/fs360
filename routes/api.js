...
//		console.log('RSVP: '+JSON.stringify(infoRequest))
		...
		.then(function(){
			...
			return EmailManager.sendHtmlEmail('dkwon@velocity360.io', infoRequest.email, infoRequest.event, confirmationMsg)
		})
		.then(function(){
//			var msg = 'Thanks for your interest in the '+infoRequest.event.subject+'. Please check your email for a confirmation. Looking forward to seeing you there!'
			var msg = 'Thanks for your interest in the '+infoRequest.event+'. Please check your email for a confirmation. Looking forward to seeing you there!'
